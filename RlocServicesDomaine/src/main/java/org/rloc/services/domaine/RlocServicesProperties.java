 ...
 *
 */
public class RlocServicesProperties <E, S, F> implements Serializable {
	...
	protected static final Logger LOGGER = Logger.getLogger(RlocServicesProperties.class.getName() );
	
	public RlocServicesProperties(E entrees, List<S> listSorties, List<F> listFails) {
		super();
