 ...
 *
 */
public abstract class MAS_ServicesGeneric<E, S, F> extends MAS_ServicesProperties<E, S, F> {
	...
	public MAS_ServicesGeneric(E entree, List<S> listSorties, List<F> listFails) {
